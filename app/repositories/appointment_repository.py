    ...
    def get_calendar_data(
        ...
        query = (
            db.query(
                ...
                PatientSlotBooking.fully_paid,
                PatientSlotBooking.payment_status,
                PatientSlotBooking.crt_program_booking_id,
                CrtProgramBooking.total_amount.label("crt_total_amount"),
                CrtProgramBooking.paid_amount.label("crt_paid_amount"),
                CrtProgramBooking.due_amount.label("crt_due_amount"),
                CrtProgramBooking.package_covered_amount.label("crt_package_covered_amount"),
